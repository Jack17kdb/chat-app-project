...
export const sendVerificationEmail = async (email, verificationToken) => {
    ...
    const verificationMail = {
        ...
        <h1 style="margin: 0; font-size: 24px;">MERN Chat App</h1>
        </div>

        <div style="padding: 30px; text-align: center; color: #333;">
        <h2 style="margin-bottom: 10px;">Welcome to MERN Chat App!</h2>
        ...
        <p>&copy; ${new Date().getFullYear()} MERN Chat App. All rights reserved.</p>
        </div>
        </div>
        </div>
        `,
